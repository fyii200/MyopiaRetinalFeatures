...
class trainedModel:
    ...
    def segment(self, image, image_name, blurKernelSize=(21,21), binaryThreshold=0.95):
        ...
        #  disc. This is done by selecting the most circular shape. If there's still more than one after this #
        #                             step, select the mask with the largest area.                            #
        ####################################################################################################### 
        ...
        # Save predicted mask. Note: cv.imwrite only accepts [0,255] pixel values;
        # otherwise, image will be all black.
