"""
Script containing a helper function that shows the predicted optic disc mask as a coloured overlay.
...
def show_mask(mask, ax, random_color = False):
    ...
    Return:
          mask_image (3D array) : Fundus photograph with a coloured overlay showing the optic disc mask.
    """
