...
myopeGoodVAModelG <- lm(ser ~ scale(adj_dist) + 
                              ...
                              scale(tilt), 
                        subset(myopes, va <= 0) )
tab_model(myopeGoodVAModelG, pred.labels=c("Intercept", "OD-fovea Distance", "OD Orientation", "FPI", "Age", "OD Area", "Sex", "OD-macula angle", "OD Tilt"))
...
myopeGoodVAModelB <- lm(ser ~ scale(adj_dist) + 
                              ...
                              scale(tilt), 
                        subset(myopes, va <= 0) )
tab_model(myopeGoodVAModelB, pred.labels=c("Intercept", "OD-fovea Distance", "OD Orientation", "FPI", "Age", "OD Area", "Sex", "OD-macula angle", "OD Tilt"))
